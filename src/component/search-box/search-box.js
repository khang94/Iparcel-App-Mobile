/*Khang
  * @providesModule SearchBoxCustom
...
class Search extends Component {
    ...
    componentWillReceiveProps(nextProps) {
      /*var isOpen = nextProps.isBackgroundOpen;

      this.setState({
        backgroundEnable : isOpen
      });*/
    }
    ...
    onChangeText = async (text) => {
        if(!this.state.backgroundEnable){
            this.setState({
     ...
     */
    onFocus = async () => {
        /*var enableBackground = !this.state.backgroundEnable;*/
        if(!this.state.backgroundEnable){
          this.setState({
            backgroundEnable : true
          });
    ...
    onCancel = async () => {
      ...
      if(this.state.backgroundEnable){
        this.setState({
          backgroundEnable : enableBackground
        });
      }
    ...
    render() {
        ...
        <AnimatedTextInput
          ref="input_keyword"
          style={[
            (this.state.backgroundEnable) ? styles.input : styles.inputDisable,
          ...
          placeholderTextColor={ (this.state.backgroundEnable) ? styles.placeholderColorOpen : styles.placeholderColor}
                ...
                <TouchableWithoutFeedback onPress={this.onFocus}>
                    {((this.props.iconSearch) ?
                        ...
                        <Animated.Image
                            ...
                            style={[
                                styles.iconSearch,
                                (this.state.backgroundEnable) ? styles.iconSearchOpen : styles.iconSearchDefault,
...
Search.propTypes = {
    /** background enable
    */
    isBackgroundOpen : PropTypes.func,
    /**
     * onFocus
     * return a Promise
